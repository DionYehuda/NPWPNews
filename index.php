...
<body>
	...
	<div id="mySidenav" class="sidenav">
		<form action ="" method="post">
			...
			<a href="model/kategori.php?kategori=Olahraga">Olahraga</a>
			<a href="model/kategori.php?kategori=Ekonomi">Ekonomi</a>
			<a href="model/kategori.php?kategori=Politik">Politik</a>
			<a href="model/kategori.php?kategori=Permainan">Permainan</a>
		</form>
	</div>
