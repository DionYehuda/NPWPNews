...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<h2>Kategori</h2>
		<a href="../view/user.php">Home</a>
		<a href="kategoriusr.php?kategori=Olahraga">Olahraga</a>
		<a href="kategoriusr.php?kategori=Ekonomi">Ekonomi</a>
		<a href="kategoriusr.php?kategori=Politik">Politik</a>
		<a href="kategoriusr.php?kategori=Permainan">Permainan</a>
	</div>
	...
	<div class="container">
			<table id="example" class="table" style="width:100%">
				<tbody>
					...
					?>
					<tr class="zoom">
                        <td><a href="../view/detailusr.php?nomor=<?= $row['nomor']; ?>"><h2> <?= $row['judul'] ?> </h2><h3><?= $row['kategori'] ?></h3><?= $row['penulis'] ?> (<?= $row['tanggal'] ?>)
