...
<body>
		...
		<nav class="navbar-inverse">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-right ">
                    <li class="inactive"><a href="../index.php" style="cursor:pointer;"> Home </a></li>
    ...
    <div class="tab">
        ...
        <form class="clearfix" action="" method="post" id="comment">
		    <h4>Post a comment:</h4>
		    <textarea name="comment_text" id="comment_text" class="form-control" cols="30" rows="3"></textarea>
		    <button type="submit" name="comment" class="btn btn-primary btn-sm pull-right" id="comment">Submit comment</button>
	    </form>
    </div>
</body>
</html>